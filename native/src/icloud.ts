...
// things the browser cannot: it serves the medication log from inside the
...
//
// What this module is NOT allowed to do is decide anything about the
// medication log. It moves bytes: a file in, a file out. Which dose is due, what a
// break counts for and how two devices' edits reconcile are all the web app's
// (`src/app/schedule.ts`, `stats.ts`, `merge.ts`) — a Swift copy of any of that is
