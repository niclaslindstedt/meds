 ...
 * would come back to an empty container and the user's log would appear to
 ...
 */
export const ICLOUD_CONTAINER = "iCloud.se.agilator.meds";
 ...
 * the file holding their own log. A medication log that syncs to a place its
