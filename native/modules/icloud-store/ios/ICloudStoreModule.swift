...
// part of the medication log's own logic is reimplemented here. This module
...
private let CONTAINER_ID = "iCloud.se.agilator.meds"
...
/// A medication log is tens of kilobytes, so this is generous; the point of the
...
private let WORK_QUEUE = DispatchQueue(
  label: "se.agilator.meds.icloud-store", qos: .utility
)
