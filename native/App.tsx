...
// a website. Those two are that it serves the medication log FROM INSIDE THE
...
// and every bar that meets an edge (the top bar, the bottom nav) pads
// itself with `env(safe-area-inset-*)` — which is how the installed PWA looks.
// Framing the WebView inside the safe area instead zeroes those insets and
// leaves two flat bands above and below the page, so the bars stop short of
...
export default function App() {
  ...
  // wrapper keeps no copy of anybody's medications.
    ...
    return (
      <SafeAreaProvider>
        <SafeAreaView style={styles.center}>
          ...
          <Text style={styles.errorTitle}>Could not start Meds</Text>
      ...
      >
        ...
        {origin ? (
          <WebView
            ...
            // which is where every dose the user has logged lives.
            domStorageEnabled
