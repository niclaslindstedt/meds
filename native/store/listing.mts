...
export const RULES: StoreRules = {
  ...
  brand: {
    ...
    // behaviour does.
    privacyUrl: "https://apps.agilator.se/meds/privacy/",
    supportUrl: "https://apps.agilator.se/meds/support/",
  },

  // Meds ships on the App Store alone. There is no Mac App Store record and
  ...
  apple: {
    ...
    advisory: {
      ...
      // call: the app keeps the reader's own medications and schedule and
      // shows which doses were taken.
      ...
      // NONE, though the app is full of medication names: the question is
      // about alcohol, tobacco and drug USE — recreational or illicit — and
      // a prescription on a schedule is neither.
      alcoholTobaccoOrDrugUseOrReferences: "NONE",
      // The one judgement call, and answered up rather than down. The
      ...
      // one review could fairly call wrong.
    ...
    contact: {
      ...
      // Nothing to sign in to and no permission prompt: a reviewer adds a
      // medication and ticks a dose. The history screens start empty, so the
      // review notes (copy.mts) are the place to say how to fill them.
      demoRequired: false,
    },
