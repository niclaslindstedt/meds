...
export function buildManifest(base: string): string {
  ...
  const manifest = {
    ...
    short_name,
    description:
      "A privacy-first medication tracker PWA: enter your medications and when to take them, log each dose with one tap, and read your adherence history, calendar and stats. Local-only or cloud-synced (Dropbox).",
    id: base,
    start_url: base,
    scope: base,
    display: "standalone",
  ...
  return {
    ...
    transformIndexHtml(): HtmlTagDescriptor[] {
      return [
        ...
        {
          tag: "meta",
          attrs: { name: "apple-mobile-web-app-title", content: "Meds" },
          injectTo: "head",
        },
      ];
    },
