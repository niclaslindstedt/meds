...
// two things you *do* rather than places you go — adding a medication, and
// changing a setting.
//
...
// Adding a medication and changing a setting are neither of those: you go,
// you do the thing, you come back. So they are buttons, and pressing one a
// second time comes back rather than stranding you on a screen with no tab
// lit.
//
...
// accent the dose toggles wear, and inverts to an outline while the Add
// screen is showing — the same "filled means happening, outlined means
// expected" grammar the calendar's marks use.
    ...
    <header className="app-header flex shrink-0 items-center justify-between gap-2 border-b border-line bg-surface-3 px-4 pb-3">
      ...
      <div className="flex shrink-0 items-center gap-2">
        ...
        <button
          type="button"
          onClick={() => onOpen("add")}
          aria-label={t("nav.addMedication")}
          aria-current={onAdd ? "page" : undefined}
          title={t("nav.addMedication")}
